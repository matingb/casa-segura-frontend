...
export function mapApiProductoToProducto(apiProd: any): Producto {
  return {
    ...
    alto: apiProd.alto != null ? Number(apiProd.alto) : 0,
    unidadAlto: apiProd.unidad_alto ?? 'cm',
    ancho: apiProd.ancho != null ? Number(apiProd.ancho) : 0,
    unidadAncho: apiProd.unidad_ancho ?? 'cm',
    profundidad: apiProd.profundidad != null ? Number(apiProd.profundidad) : 0,
    unidadProfundidad: apiProd.unidad_profundidad ?? 'cm',
    pesoUnitario: apiProd.peso_unitario != null ? Number(apiProd.peso_unitario) : 0,
    unidadPesoUnitario: apiProd.unidad_peso_unitario ?? 'kg',
